...
export interface ApiDoctorAccountDoctorAccount
  extends Struct.CollectionTypeSchema {
  collectionName: 'doctor_accounts';
  info: {
    description: 'Links a registered user to a doctor card.';
    displayName: 'Doctor Account';
    pluralName: 'doctor-accounts';
    singularName: 'doctor-account';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::doctor-account.doctor-account'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiDoctorDoctor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    about_ar: Schema.Attribute.Text;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::doctor-account.doctor-account': ApiDoctorAccountDoctorAccount;
